...
import br.cefet.todo.adapter.ArchivedTaskAdapter;
...
public class Archived extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.archive_recycler_view_tasks);

        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);

        List<Task> tasks =new TaskRepository(connection).selectToArchived();

        archivedTaskAdapter = new ArchivedTaskAdapter(tasks);
        recyclerView.setAdapter(archivedTaskAdapter);
    }
